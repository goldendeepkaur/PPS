...
#### **<p align="center">Name - _Sourabh chouhan_ </p>**
#### **<p align="center">CRN - _1915352_</p>**
...
```
![myName.png](https://i.imgur.com/NSiEX8G.png)
---
...
```
![collegeAdd.png](https://i.imgur.com/ax6bZ3H.png)
---
...
```
![add.png](https://i.imgur.com/BaHUHFI.png)
---
...
```
![quotientRemainder.png](https://i.imgur.com/uFqYSxi.png)
---
...
```
![swapW3.c](https://i.imgur.com/O2vlkcf.png)
---
...
```
![oddEven.c](https://i.imgur.com/f88BlWv.png)
---
...
```
![greatest.c](https://i.imgur.com/vvorXlM.png)
---
...
```
![graetest3.c](https://i.imgur.com/ZKjVjKB.png)
---
...
```
![grade.c](https://i.imgur.com/UEzf2Fa.png)
---
...
```
![leapyr.c](https://i.imgur.com/cwsLcyc.png)
---
...
```
![table5](https://i.imgur.com/rGWm4un.png)
---
...
```
![simpleCalc.c](https://i.imgur.com/vQQNoJC.png)
---
...
```
![reverse.c](https://i.imgur.com/qkbURW3.png)
---
...
```
![palindrome.c](https://i.imgur.com/HYE2SxG.png)
---
...
```
![prime.c](https://i.imgur.com/cobB3E9.png)
---
...
printf(" The prime numbers between 1 and 100 : \n");
 ...
 ```
![prime100.c](https://i.imgur.com/9f4kqUx.png)
---
...
```
![armstrong.c](https://i.imgur.com/A5OhO51.png)
---
...
```
![pattern1.c](https://i.imgur.com/3jkMiWr.png)
#### ii) Pattern 2 
```C
#include <stdio.h>
int main() {
...
```
![pattern2.c](https://i.imgur.com/rX4HDsU.png)
---
...
```
![largest1dArray.c](https://i.imgur.com/BJ74j5m.png)
---
...
```
![naturalArray.c](https://i.imgur.com/jYrFx2A.png)
---
...
```
![matadd2.c](https://i.imgur.com/Mrl3qii.png)
---
...
```
![matmul.c](https://i.imgur.com/qU4h52J.png)
---
...
```
![palindromeString.c](https://i.imgur.com/xuikjqt.png)
---
...
```
![1 string.c](https://i.imgur.com/vtWyi6f.png)
---
...
```
![swapRef.c](https://i.imgur.com/Pp5yzpR.png)
#### call by value 
```C
/* Call by value */
...
```
![swapVal.c](https://i.imgur.com/jwehWia.png)
---
...
```
![factRec.c](https://i.imgur.com/imf2Dhm.png)
...
```
![factWRec.c](https://i.imgur.com/eIZz1zG.png)
---
...
```
![fibrec.c](https://i.imgur.com/uCieoXY.png)
...
```
![fibWrec.c](https://i.imgur.com/mz7AucT.png)
---
...
int main() { int a1,a2,a3,a4,a5,res;
 ...
 ```
![averageFun.c](https://i.imgur.com/40hKV9N.png)
---
...
```
![linear.c](https://i.imgur.com/zeHWTQU.png)
```C
/* Binary Search */
...
```
![binary.c](https://i.imgur.com/IBuIKew.png)
---
...
```
![bubble.c](https://i.imgur.com/J4w9qBc.png)
---
...
```
![student10Struct.c](https://i.imgur.com/3jZwubx.png)
---
...
```
![transpose.c](https://i.imgur.com/0I2yPhu.png)
---
...
```
![pointerAddVar.c](https://i.imgur.com/bZhs0eR.png)
---
...
```
![pointerArray.c](https://i.imgur.com/cxcL4Uc.png)
